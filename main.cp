...
int main() {
  ...
  int imageHeight = 500;
  string line;
  ifstream myFile ("/afs/csl.tjhsst.edu/students/2018/2018amishra/Development-master/cv/labs/shapes/cube.txt");
  getline (myFile,line);
  ...
  ifstream myFile1 ("/afs/csl.tjhsst.edu/students/2018/2018amishra/Development-master/cv/labs/shapes/cubeEdges.txt");
